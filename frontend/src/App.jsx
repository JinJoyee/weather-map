    ...
    <>
      ...
      <Routes>
        <Route
          path="/"
          element={
            <div className="min-h-screen bg-neutral dark:bg-surface-dark flex flex-col items-center justify-center px-6 py-10">
              <header className="text-center mb-10">
                <h1 className="text-5xl text-secondary dark:text-blue-300 font-extrabold mb-3">
                  Weather Map System
                </h1>
              ...
              <div className="glass-panel p-8 max-w-md w-full">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h3 className="text-xl font-bold text-[#191C1E] dark:text-slate-100">
                    오늘의 추천 경로
                  </h3>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-primary dark:bg-blue-600 text-white py-3 rounded-lvl2 font-bold hover:scale-[1.03] transition-all"
                >
                  탐색 시작하기
                </button>
              </div>
        ...
        <Route
          path="*"
          element={
            <div className="min-h-screen bg-neutral dark:bg-surface-dark flex flex-col items-center justify-center px-6">
              <div className="glass-panel p-8 max-w-md w-full text-center">
                <span className="material-symbols-outlined text-primary text-6xl mb-4 block">
                  travel_explore
                </span>

                <h2 className="text-3xl font-bold text-secondary dark:text-blue-300 mb-3">
                  404
                </h2>
